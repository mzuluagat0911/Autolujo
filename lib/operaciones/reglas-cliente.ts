...
export function reglasOperacionesCliente(): string {
  return [
    ...
    `- EMERGENCIAS DEL CARRO (colisión, daño, seguro, o que el carro no funciona): SIEMPRE`,
    `  deriva al teléfono correcto, a cualquier hora (dentro o fuera de 8:00 a.m. – 7:00 p.m.):`,
    `  · Colisión, accidente, daño, golpe, o algo de SEGURO → que llame YA a Santiago: +507 6929-1946.`,
    `  · Mecánica / el carro no prende, no anda, se dañó por falla, no puede operar → que llame YA a`,
    `    Néstor: +507 6330-3437.`,
    `  Dale el número completo en el mensaje. Sé corto y claro. NO inventes otros números.`,
