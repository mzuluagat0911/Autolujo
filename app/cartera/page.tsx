        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Acceso href="/cartera/licencias" titulo="Licencias" desc="Semáforo por vencimiento de licencia" />
              <Acceso href="/cartera/mantenimiento" titulo="Mantenimiento" desc="Carros por km (FULL cada 6.000)" />
              <Acceso href="/cartera/placas" titulo="Placas y revisado" desc="Vencimientos del revisado" />
            </div>
          </div>
        </div>
      )}
