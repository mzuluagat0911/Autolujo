          ...
          <tbody>
            {filas.map((u) => (
              <tr key={u.id} className="border-b border-line last:border-0">
                  ...
                  {u.id === yo.id ? (
                    ...
                    <form action={cambiarRol} className="flex items-center gap-2">
                      ...
                      <select
                        name="rol"
                        defaultValue={u.rol}
                        className="rounded-md bg-paper px-2 py-1 text-sm ring-1 ring-line"
                      >
                ...
                <td className="px-5 py-3">
                  <StatusChip tone={u.activo ? "good" : "neutral"}>{u.activo ? "activo" : "off"}</StatusChip>
                </td>
